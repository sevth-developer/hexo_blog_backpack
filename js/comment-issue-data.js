...
var repoIssuesUrl = "https://api.github.com/repos/sevth-developer/gittalk_commit/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://removeif.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
var clientId = "07e2f41b7bcd1f4012fd";
var clientSecret = "e9ecd737c87296db71503ddd874b8a9d44a3942a";
...
// 管理员名称,评论时添加 [博主] 后缀
var ADMIN_NAME = "sevth-developer";
...
function loadIssueData() {
    setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        console.clear();
        console.log("~~~~欢迎光临！记得有时间多来看看哦，https://sevth.com/ ~~~~")
    }
    ,
    500
)
